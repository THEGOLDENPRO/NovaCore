package net.zeeraa.novacore.command.commands.novacore;
...
import net.zeeraa.novacore.command.commands.novacore.gotoworld.NovaCoreSubCommandGoToWorld;
import net.zeeraa.novacore.command.commands.novacore.logger.NovaCoreSubCommandLogger;
import net.zeeraa.novacore.command.commands.novacore.loottable.NovaCoreSubCommandLootTable;
import net.zeeraa.novacore.command.commands.novacore.module.NovaCoreSubCommandModules;
import net.zeeraa.novacore.command.commands.novacore.whereami.NovaCoreSubCommandWhereAmI;
