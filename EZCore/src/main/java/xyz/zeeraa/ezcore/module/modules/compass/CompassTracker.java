...
import xyz.zeeraa.ezcore.module.modules.compass.event.CompassTrackingEvent;
...
public class CompassTracker extends EZModule {
	...
	public void onPlayerInteract(PlayerInteractEvent e) {
		if (e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) {
			if (EZCore.getInstance().getVersionIndependentUtils().getItemInMainHand(e.getPlayer()).getType() == Material.COMPASS) {
				if (!hasCompassTrackerTarget()) {
					return;
				}
