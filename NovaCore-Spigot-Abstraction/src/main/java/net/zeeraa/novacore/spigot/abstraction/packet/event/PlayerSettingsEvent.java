...
public class PlayerSettingsEvent extends AsyncPacketEvent {
	...
	public PlayerSettingsEvent(Player player, String language, int chunkDistance, ChatVisibility chatVisibility, boolean chatColored, int skinCustomization, MainHand mainHand, boolean textFiltering, boolean serverListing) {
		super(player);
