...
public enum VersionIndependentSound {
	NOTE_PLING, NOTE_HAT, WITHER_DEATH, WITHER_HURT, ITEM_BREAK, ITEM_PICKUP, ORB_PICKUP, ANVIL_LAND, ANVIL_BREAK, EXPLODE, LEVEL_UP, WITHER_SHOOT, EAT, FIZZ, ENDERMAN_TELEPORT;
